...
| 21 个功能模块 | 6 大分组导航，完整覆盖 DeFi 风险管理全流程 |
...
| Frontend (React/TypeScript) | 51 | 4,100+ | 6 分组 × 21 Tab |
...
│ Landing Page + 6 分组导航 × 21 功能模块                      │
│ 总览(概览·Portfolio·趋势) · Oracle(评分·风险分解·宏观)       │
│ 清算(保护·瀑布·热图·预测) · 市场(传导图·鲸鱼·压力测试)      │
│ 协议(多协议·排名·调仓·Vault·归因) · 告警(规则·告警流·回测)  │
└─────────────────────────────────────────────────────────────┘
```
